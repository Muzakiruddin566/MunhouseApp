      ...
      <div className="mx-auto w-full p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 space-y-4">
            <div className="text-2xl text-white font-bold dark:text-white">
              MUNHouse
            </div>
            <p className="text-base text-white dark:text-white font-medium">
              Discover your perfect home with MUNHouse - intuitive map searches,
              <br />
              tailored property filters, and direct viewing bookings at your
              fingertips.
            </p>
          </div>
